...
class Renderer:
    ...
    def render(self, filename):
        ...
        htmlfile.write('      <li><a href="#statisticsAnchor">Statistics</a></li>')
        htmlfile.write("    </ol>")
        htmlfile.write("  </nav>\n")
        ...
        if len(self.artifact.kijijiSale.links) > 0:
            ...
            htmlfile.write("    </dl>\n")
        htmlfile.write("  </section>\n")
        if self.artifact.statisticsUrl != "":
            htmlfile.write('  <section id="statisticsSection">\n')
            htmlfile.write('    <a id="statisticsAnchor"></a>\n')
            htmlfile.write("    <h2>4. Statistics</h2>\n")
            htmlfile.write("    <dl>\n")
            htmlfile.write("      <dt>Sales Statistics:</dt>\n")
            htmlfile.write("      <dd><a href=\"%s\">Rick's Database</a></dd>\n" % self.artifact.statisticsUrl)
            htmlfile.write("    </dl>\n")
            htmlfile.write("  </section>\n")
        htmlfile.write("</body>")
        htmlfile.close()
